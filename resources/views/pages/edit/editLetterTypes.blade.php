<div class="modal fade" id="modalEditKategoriSurat" tabindex="-1" aria-labelledby="modalTEditKategoriSuratLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditKategoriSuratLabel">Ubah Kategori Surat</h5>
    ...
    editBtn.addEventListener('click', function(e) {
        ...
        async function handleEdit() {
            try {
                ...
                await axios.put(`/api/letterType/${id}`, {
                    name: nama,
