<div class="modal fade" id="modalEditPengumuman" tabindex="-1" aria-labelledby="modalTEditPengumumanLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditPengumumanLabel">Ubah Pengumuman</h5>
...
<script>
    ...
    editBtn.addEventListener('click', function(e) {
        ...
        formData.append('folder', 'bangkal-app/announcement');
        ...
        async function handleEdit() {
            try {
                ...
                await axios.put(`/api/announcement/${id}`, {
                    title: nama,
                    text: deskripsi,
                    image_url: imageUrl,
                    date: tanggal,
