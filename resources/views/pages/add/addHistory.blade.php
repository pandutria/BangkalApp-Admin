<div class="modal fade" id="modalTambahSejarah" tabindex="-1" aria-labelledby="modalTambahSejarahLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahSejarahLabel">Tambah Sejarah</h5>
...
<script>
    ...
    submitBtn.addEventListener('click', function(e) {
        ...
        formData.append('folder', 'bangkal-app/history');
